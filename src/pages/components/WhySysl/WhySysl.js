...
const badges = [
    {
        ...
        description: (<>Sysl is built for change. With Sysl, your specifications become the single source of truth. All the related system specifications, code, diagrams, documentations keep the same version - no more stale designs. Also, in unified good style.</>),
    },
    {
        title: <>Quality  Built-in</>,
        imageUrl: 'img/icon/Quality Built-in.svg',
        description: (<>With Sysl, you can generate high-quality code, diagrams and documentation which align to your style guide and best practices. Embed security in from the start.</>)
    },
    {
        title: <>Flexible</>,
        imageUrl: 'img/icon/Flexible.svg',
        description: (<>Sysl's open-ended architecture makes it possible to generate code for any programming language, with out-of-the-box support for Go.</>),
    },
]
