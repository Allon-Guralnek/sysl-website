          ...
          <div className={styles.deliver__body}>
            <div className={styles.deliver__left}>
              ...
              <div className={styles.deliver__button__group__left}>
                <Link to={useBaseUrl('docs/lang-spec')} className={classnames('button button--primary button--lg', styles.button__round)}>Sysl</Link>
                <Link to={useBaseUrl('docs/cmd-import')} className={classnames('button button--primary button--lg', styles.button__round)}>OpenAPI2/OpenAPI3</Link>
                <Link to={useBaseUrl('docs/cmd-import')} className={classnames('button button--primary button--lg', styles.button__round)}>Protobuf</Link>
                <Link to={useBaseUrl('docs/cmd-import')} className={classnames('button button--primary button--lg', styles.button__round)}>XSD</Link>
              </div>
            ...
            <div className={styles.deliver__middle}>
              ...
              <h1 className={classnames('text--primary text--center', styles.deliver__middle__title)}>Sysl</h1>
            </div>
